#############################################################################
# Makefile for building: sabot.app/Contents/MacOS/sabot
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon Mar 17 15:33:46 2014
# Project:  sabot.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile sabot.pro
#############################################################################
...
QMAKE_TARGET  = sabot
DESTDIR       = 
TARGET        = sabot.app/Contents/MacOS/sabot
...
all: Makefile sabot.app/Contents/PkgInfo sabot.app/Contents/Resources/empty.lproj sabot.app/Contents/Info.plist $(TARGET)

$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) sabot.app/Contents/MacOS/ || $(MKDIR) sabot.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: sabot.pro  /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang/qmake.conf /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/clang.conf \
...
sabot.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) sabot.app/Contents || $(MKDIR) sabot.app/Contents 
	@$(DEL_FILE) sabot.app/Contents/PkgInfo
	@echo "APPL????" >sabot.app/Contents/PkgInfo
sabot.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) sabot.app/Contents/Resources || $(MKDIR) sabot.app/Contents/Resources 
	@touch sabot.app/Contents/Resources/empty.lproj
	
sabot.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) sabot.app/Contents || $(MKDIR) sabot.app/Contents 
	@$(DEL_FILE) sabot.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,sabot,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang/Info.plist.app >sabot.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/sabot1.0.0 || $(MKDIR) .tmp/sabot1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sabot1.0.0/ && $(COPY_FILE) --parents mainwindow.h crypt.h database.h sanet.h .tmp/sabot1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp crypt.c database.c sanet.c general.c .tmp/sabot1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/sabot1.0.0/ && (cd `dirname .tmp/sabot1.0.0` && $(TAR) sabot1.0.0.tar sabot1.0.0 && $(COMPRESS) sabot1.0.0.tar) && $(MOVE) `dirname .tmp/sabot1.0.0`/sabot1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sabot1.0.0
...
crypt.o: crypt.c crypt.h \
		general.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o crypt.o crypt.c

database.o: database.c crypt.h \
		general.h \
		database.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o database.o database.c

sanet.o: sanet.c general.h \
		sanet.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o sanet.o sanet.c

general.o: general.c general.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o general.o general.c
