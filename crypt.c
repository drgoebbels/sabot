...
static word_u rcon[256] = {
    .b = {0x01, 0x00, 0x00, 0x00}, .b = {0x02, 0x00, 0x00, 0x00}, .b = {0x04, 0x00, 0x00, 0x00}, .b = {0x08, 0x00, 0x00, 0x00},
    .b = {0x10, 0x00, 0x00, 0x00}, .b = {0x20, 0x00, 0x00, 0x00}, .b = {0x40, 0x00, 0x00, 0x00}, .b = {0x80, 0x00, 0x00, 0x00},
    .b = {0x1b, 0x00, 0x00, 0x00}, .b = {0x36, 0x00, 0x00, 0x00}, .b = {0x6c, 0x00, 0x00, 0x00}, .b = {0xd8, 0x00, 0x00, 0x00},
    .b = {0xab, 0x00, 0x00, 0x00}, .b = {0x4d, 0x00, 0x00, 0x00}, .b = {0x9a, 0x00, 0x00, 0x00}, .b = {0x2f, 0x00, 0x00, 0x00},
    .b = {0x5e, 0x00, 0x00, 0x00}, .b = {0xbc, 0x00, 0x00, 0x00}, .b = {0x63, 0x00, 0x00, 0x00}, .b = {0xc6, 0x00, 0x00, 0x00},
    .b = {0x97, 0x00, 0x00, 0x00}, .b = {0x35, 0x00, 0x00, 0x00}, .b = {0x6a, 0x00, 0x00, 0x00}, .b = {0xd4, 0x00, 0x00, 0x00},
    .b = {0xb3, 0x00, 0x00, 0x00}, .b = {0x7d, 0x00, 0x00, 0x00}, .b = {0xfa, 0x00, 0x00, 0x00}, .b = {0xef, 0x00, 0x00, 0x00},
    .b = {0xc5, 0x00, 0x00, 0x00}, .b = {0x91, 0x00, 0x00, 0x00}, .b = {0x39, 0x00, 0x00, 0x00}, .b = {0x72, 0x00, 0x00, 0x00},
    .b = {0xe4, 0x00, 0x00, 0x00}, .b = {0xd3, 0x00, 0x00, 0x00}, .b = {0xbd, 0x00, 0x00, 0x00}, .b = {0x61, 0x00, 0x00, 0x00},
    .b = {0xc2, 0x00, 0x00, 0x00}, .b = {0x9f, 0x00, 0x00, 0x00}, .b = {0x25, 0x00, 0x00, 0x00}, .b = {0x4a, 0x00, 0x00, 0x00},
    .b = {0x94, 0x00, 0x00, 0x00}, .b = {0x33, 0x00, 0x00, 0x00}, .b = {0x66, 0x00, 0x00, 0x00}, .b = {0xcc, 0x00, 0x00, 0x00},
    .b = {0x83, 0x00, 0x00, 0x00}, .b = {0x1d, 0x00, 0x00, 0x00}, .b = {0x3a, 0x00, 0x00, 0x00}, .b = {0x74, 0x00, 0x00, 0x00},
    .b = {0xe8, 0x00, 0x00, 0x00}, .b = {0xcb, 0x00, 0x00, 0x00}, .b = {0x8d, 0x00, 0x00, 0x00}, .b = {0x01, 0x00, 0x00, 0x00},
    .b = {0x02, 0x00, 0x00, 0x00}, .b = {0x04, 0x00, 0x00, 0x00}, .b = {0x08, 0x00, 0x00, 0x00}, .b = {0x10, 0x00, 0x00, 0x00},
    .b = {0x20, 0x00, 0x00, 0x00}, .b = {0x40, 0x00, 0x00, 0x00}, .b = {0x80, 0x00, 0x00, 0x00}, .b = {0x1b, 0x00, 0x00, 0x00},
    .b = {0x36, 0x00, 0x00, 0x00}, .b = {0x6c, 0x00, 0x00, 0x00}, .b = {0xd8, 0x00, 0x00, 0x00}, .b = {0xab, 0x00, 0x00, 0x00},
    .b = {0x4d, 0x00, 0x00, 0x00}, .b = {0x9a, 0x00, 0x00, 0x00}, .b = {0x2f, 0x00, 0x00, 0x00}, .b = {0x5e, 0x00, 0x00, 0x00},
    .b = {0xbc, 0x00, 0x00, 0x00}, .b = {0x63, 0x00, 0x00, 0x00}, .b = {0xc6, 0x00, 0x00, 0x00}, .b = {0x97, 0x00, 0x00, 0x00},
    .b = {0x35, 0x00, 0x00, 0x00}, .b = {0x6a, 0x00, 0x00, 0x00}, .b = {0xd4, 0x00, 0x00, 0x00}, .b = {0xb3, 0x00, 0x00, 0x00},
    .b = {0x7d, 0x00, 0x00, 0x00}, .b = {0xfa, 0x00, 0x00, 0x00}, .b = {0xef, 0x00, 0x00, 0x00}, .b = {0xc5, 0x00, 0x00, 0x00},
    .b = {0x91, 0x00, 0x00, 0x00}, .b = {0x39, 0x00, 0x00, 0x00}, .b = {0x72, 0x00, 0x00, 0x00}, .b = {0xe4, 0x00, 0x00, 0x00},
    .b = {0xd3, 0x00, 0x00, 0x00}, .b = {0xbd, 0x00, 0x00, 0x00}, .b = {0x61, 0x00, 0x00, 0x00}, .b = {0xc2, 0x00, 0x00, 0x00},
    .b = {0x9f, 0x00, 0x00, 0x00}, .b = {0x25, 0x00, 0x00, 0x00}, .b = {0x4a, 0x00, 0x00, 0x00}, .b = {0x94, 0x00, 0x00, 0x00},
    .b = {0x33, 0x00, 0x00, 0x00}, .b = {0x66, 0x00, 0x00, 0x00}, .b = {0xcc, 0x00, 0x00, 0x00}, .b = {0x83, 0x00, 0x00, 0x00},
    .b = {0x1d, 0x00, 0x00, 0x00}, .b = {0x3a, 0x00, 0x00, 0x00}, .b = {0x74, 0x00, 0x00, 0x00}, .b = {0xe8, 0x00, 0x00, 0x00},
    .b = {0xcb, 0x00, 0x00, 0x00}, .b = {0x8d, 0x00, 0x00, 0x00}, .b = {0x01, 0x00, 0x00, 0x00}, .b = {0x02, 0x00, 0x00, 0x00},
    .b = {0x04, 0x00, 0x00, 0x00}, .b = {0x08, 0x00, 0x00, 0x00}, .b = {0x10, 0x00, 0x00, 0x00}, .b = {0x20, 0x00, 0x00, 0x00},
    .b = {0x40, 0x00, 0x00, 0x00}, .b = {0x80, 0x00, 0x00, 0x00}, .b = {0x1b, 0x00, 0x00, 0x00}, .b = {0x36, 0x00, 0x00, 0x00},
    .b = {0x6c, 0x00, 0x00, 0x00}, .b = {0xd8, 0x00, 0x00, 0x00}, .b = {0xab, 0x00, 0x00, 0x00}, .b = {0x4d, 0x00, 0x00, 0x00},
    .b = {0x9a, 0x00, 0x00, 0x00}, .b = {0x2f, 0x00, 0x00, 0x00}, .b = {0x5e, 0x00, 0x00, 0x00}, .b = {0xbc, 0x00, 0x00, 0x00},
    .b = {0x63, 0x00, 0x00, 0x00}, .b = {0xc6, 0x00, 0x00, 0x00}, .b = {0x97, 0x00, 0x00, 0x00}, .b = {0x35, 0x00, 0x00, 0x00},
    .b = {0x6a, 0x00, 0x00, 0x00}, .b = {0xd4, 0x00, 0x00, 0x00}, .b = {0xb3, 0x00, 0x00, 0x00}, .b = {0x7d, 0x00, 0x00, 0x00},
    .b = {0xfa, 0x00, 0x00, 0x00}, .b = {0xef, 0x00, 0x00, 0x00}, .b = {0xc5, 0x00, 0x00, 0x00}, .b = {0x91, 0x00, 0x00, 0x00},
    .b = {0x39, 0x00, 0x00, 0x00}, .b = {0x72, 0x00, 0x00, 0x00}, .b = {0xe4, 0x00, 0x00, 0x00}, .b = {0xd3, 0x00, 0x00, 0x00},
    .b = {0xbd, 0x00, 0x00, 0x00}, .b = {0x61, 0x00, 0x00, 0x00}, .b = {0xc2, 0x00, 0x00, 0x00}, .b = {0x9f, 0x00, 0x00, 0x00},
    .b = {0x25, 0x00, 0x00, 0x00}, .b = {0x4a, 0x00, 0x00, 0x00}, .b = {0x94, 0x00, 0x00, 0x00}, .b = {0x33, 0x00, 0x00, 0x00},
    .b = {0x66, 0x00, 0x00, 0x00}, .b = {0xcc, 0x00, 0x00, 0x00}, .b = {0x83, 0x00, 0x00, 0x00}, .b = {0x1d, 0x00, 0x00, 0x00},
    .b = {0x3a, 0x00, 0x00, 0x00}, .b = {0x74, 0x00, 0x00, 0x00}, .b = {0xe8, 0x00, 0x00, 0x00}, .b = {0xcb, 0x00, 0x00, 0x00},
    .b = {0x8d, 0x00, 0x00, 0x00}, .b = {0x01, 0x00, 0x00, 0x00}, .b = {0x02, 0x00, 0x00, 0x00}, .b = {0x04, 0x00, 0x00, 0x00},
    .b = {0x08, 0x00, 0x00, 0x00}, .b = {0x10, 0x00, 0x00, 0x00}, .b = {0x20, 0x00, 0x00, 0x00}, .b = {0x40, 0x00, 0x00, 0x00},
    .b = {0x80, 0x00, 0x00, 0x00}, .b = {0x1b, 0x00, 0x00, 0x00}, .b = {0x36, 0x00, 0x00, 0x00}, .b = {0x6c, 0x00, 0x00, 0x00},
    .b = {0xd8, 0x00, 0x00, 0x00}, .b = {0xab, 0x00, 0x00, 0x00}, .b = {0x4d, 0x00, 0x00, 0x00}, .b = {0x9a, 0x00, 0x00, 0x00},
    .b = {0x2f, 0x00, 0x00, 0x00}, .b = {0x5e, 0x00, 0x00, 0x00}, .b = {0xbc, 0x00, 0x00, 0x00}, .b = {0x63, 0x00, 0x00, 0x00},
    .b = {0xc6, 0x00, 0x00, 0x00}, .b = {0x97, 0x00, 0x00, 0x00}, .b = {0x35, 0x00, 0x00, 0x00}, .b = {0x6a, 0x00, 0x00, 0x00},
    .b = {0xd4, 0x00, 0x00, 0x00}, .b = {0xb3, 0x00, 0x00, 0x00}, .b = {0x7d, 0x00, 0x00, 0x00}, .b = {0xfa, 0x00, 0x00, 0x00},
    .b = {0xef, 0x00, 0x00, 0x00}, .b = {0xc5, 0x00, 0x00, 0x00}, .b = {0x91, 0x00, 0x00, 0x00}, .b = {0x39, 0x00, 0x00, 0x00},
    .b = {0x72, 0x00, 0x00, 0x00}, .b = {0xe4, 0x00, 0x00, 0x00}, .b = {0xd3, 0x00, 0x00, 0x00}, .b = {0xbd, 0x00, 0x00, 0x00},
    .b = {0x61, 0x00, 0x00, 0x00}, .b = {0xc2, 0x00, 0x00, 0x00}, .b = {0x9f, 0x00, 0x00, 0x00}, .b = {0x25, 0x00, 0x00, 0x00},
    .b = {0x4a, 0x00, 0x00, 0x00}, .b = {0x94, 0x00, 0x00, 0x00}, .b = {0x33, 0x00, 0x00, 0x00}, .b = {0x66, 0x00, 0x00, 0x00},
    .b = {0xcc, 0x00, 0x00, 0x00}, .b = {0x83, 0x00, 0x00, 0x00}, .b = {0x1d, 0x00, 0x00, 0x00}, .b = {0x3a, 0x00, 0x00, 0x00},
    .b = {0x74, 0x00, 0x00, 0x00}, .b = {0xe8, 0x00, 0x00, 0x00}, .b = {0xcb, 0x00, 0x00, 0x00}, .b = {0x8d, 0x00, 0x00, 0x00},
    .b = {0x01, 0x00, 0x00, 0x00}, .b = {0x02, 0x00, 0x00, 0x00}, .b = {0x04, 0x00, 0x00, 0x00}, .b = {0x08, 0x00, 0x00, 0x00},
    .b = {0x10, 0x00, 0x00, 0x00}, .b = {0x20, 0x00, 0x00, 0x00}, .b = {0x40, 0x00, 0x00, 0x00}, .b = {0x80, 0x00, 0x00, 0x00},
    .b = {0x1b, 0x00, 0x00, 0x00}, .b = {0x36, 0x00, 0x00, 0x00}, .b = {0x6c, 0x00, 0x00, 0x00}, .b = {0xd8, 0x00, 0x00, 0x00},
    .b = {0xab, 0x00, 0x00, 0x00}, .b = {0x4d, 0x00, 0x00, 0x00}, .b = {0x9a, 0x00, 0x00, 0x00}, .b = {0x2f, 0x00, 0x00, 0x00},
    ...
    .b = {0x94, 0x00, 0x00, 0x00}, .b = {0x33, 0x00, 0x00, 0x00}, .b = {0x66, 0x00, 0x00, 0x00}, .b = {0xcc, 0x00, 0x00, 0x00},
    .b = {0x83, 0x00, 0x00, 0x00}, .b = {0x1d, 0x00, 0x00, 0x00}, .b = {0x3a, 0x00, 0x00, 0x00}, .b = {0x74, 0x00, 0x00, 0x00},
    .b = {0xe8, 0x00, 0x00, 0x00}, .b = {0xcb, 0x00, 0x00, 0x00}, .b = {0x8d, 0x00, 0x00, 0x00}
};
